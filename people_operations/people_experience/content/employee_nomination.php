...
<?php
$sql = "SELECT link, id FROM p_management WHERE id = 'nomination'";
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="w-100 py-5">
                    <div class="container">
                        <h1 class="card-heading my-5 text-uppercase text-center">EMPLOYEE NOMINATION FORM</h1>
                        <?php if (empty($link)) : ?>
                        ...
                        <?php else : ?>
                            ...
                            <embed class="w-100" src="<?php echo $link ?>" height="1000px" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
                        <?php endif; ?>
                    </div>
                </div>
            </div>

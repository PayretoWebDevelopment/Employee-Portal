...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="w-100 h-100 container-gr">
                <?php
                $sql = "SELECT * FROM p_management WHERE id IN('grab_account1','grab_account2','grab_account3')";
                ...
                <div class="h-100 blur-bg">
                    <div class="container-fluid d-flex flex-column justify-content-center align-items-center">
                        <div class="container my-5 note shadow d-flex flex-column justify-content-center align-items-center ">
                            <img class="img-fluid w-25 my-3 p-0" src="../assets/img/grab-logo.png" alt="">
                            <h1 class="card-heading my-5 text-uppercase text-center">GRAB ACCOUNT ACTIVATION GUIDE</h1>
                            <!-- <img class="img-fluid" src="<?php echo $link[0] ?>" alt=""> -->
                            <img class="img-fluid w-50" src="../assets/img/Grab_Account_Linking_Guide.png" alt="">
                            <img class="img-fluid rounded w-50 py-3" src="../assets/img/Grab_Account_Linking_Steps.png" alt="">

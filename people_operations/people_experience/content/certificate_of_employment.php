...
<?php
$sql = "SELECT link, id FROM p_management WHERE id = 'certificate'";
        ...
        <div id="page-content-wrapper">
            ...
            <div class="w-100 py-5">
                <div class="container d-flex flex-column justify-content-center">
                    <h1 class="card-heading my-5 text-uppercase text-center">REQUEST FOR CERTIFICATE OF EMPLOYMENT</h1>
                    <?php if (empty($link)) : ?>

...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="w-100 h-100 container-fp">
                <?php
                ...
                <div class="h-100 blur-bg">
                    <div class="container-fluid d-flex flex-column justify-content-center align-items-center">
                        <div class="container my-5 note shadow d-flex flex-column justify-content-center align-items-center ">
                            <img class="img-fluid w-25 my-5 p-0" src="../assets/img/foodpanda-logo.png" alt="">
                            <h1 class="card-heading my-5 text-uppercase text-center">FOODPANDA ACCOUNT ACTIVATION GUIDE</h1>
                            <!-- <img class="img-fluid" src="<?php echo $link[0] ?>" alt=""> -->
                            <img class="img-fluid w-50" src="../assets/img/FP_Account_Linking_Guide.png" alt="">
                            <img class="img-fluid w-50 py-3" src="../assets/img/FP_Account_Linking_Steps.png" alt="">

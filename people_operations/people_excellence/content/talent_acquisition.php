...
<?php
$sql = "SELECT link, id FROM p_excellence WHERE id = 'talent_acq'";
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid w-100 py-5 d-flex flex-column justify-content-center align-items-center">
                <h1 class="card-heading my-5 text-uppercase text-center">TALENT ACQUISITION POLICY AND PROCEDURE</h1>
                <?php if (empty($link)) : ?>

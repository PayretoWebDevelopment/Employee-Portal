...
<?php
$sql = "SELECT link, id FROM p_excellence WHERE id = 'issuance_guide'";
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid w-100 py-5 d-flex flex-column justify-content-center align-items-center">
                <h1 class="card-heading my-5 text-uppercase text-center">COMPANY ID ISSUANCE AND WEARING GUIDELINES</h1>
                <?php if (empty($link)) : ?>

...
<head>
    ...
    <link rel="stylesheet" href="/Employee-Portal/people_services/people_support/assets/css/reimbursement_styles.css">
</head>
<title>Payreto Employee Portal | People Support</title>

<?php
$sql = "SELECT link, id FROM p_support WHERE id = 'reimbursement'";
        ...
        <div id="page-content-wrapper">
            ...
            <div class="w-100 py-5">
                <div class="container-fluid w-100 py-5 d-flex flex-column justify-content-center align-items-center">
                    <h1 class="card-heading my-5 text-uppercase text-center">EXPENSE REIMBURSEMENT FORM</h1>
                    <?php if (empty($link)) : ?>

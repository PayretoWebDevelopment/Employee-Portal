...
<?php
$sql = "SELECT link, id FROM p_support WHERE id = 'call'";
        ...
        <div id="page-content-wrapper">
            ...
            <div class="w-100 py-5">
                <div class="container d-flex flex-column justify-content-center">
                    <h1 class="card-heading my-5 text-uppercase text-center">Call Tree Process</h1>
                    <img class="w-100 my-5" src="../assets/img/Call_Tree_Process3.svg">
                </div>
                <br>
                <div class="container d-flex flex-column justify-content-center">
                    <p class="text-wrap">
                        Ensuring employee safety by rapidly disseminating the right information and keeping communication lines open in a time of crisis are both priorities for businesses.
                        Traditional solutions for this have relied on the manual 'call tree' or
                        'phone tree'. Key employees are contacted first to inform them of whatever situation or crisis has arisen, with remaining staf to be contacted as soon as possible.
                </div>
            </div>
        </div>
    </div>

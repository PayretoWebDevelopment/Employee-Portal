...
<?php
$sql = "SELECT link, id FROM e_admin WHERE id = 'e_purchase'";
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="w-100 py-5">
                <div class="container">
                    <h1 class="card-heading my-5 text-uppercase text-center">Request for Equipment Purchase</h1>
                    <?php if (empty($link)) : ?>

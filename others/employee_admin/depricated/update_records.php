...
<head>
    ...
    <link rel="stylesheet" href="assets/css/e_admin_styles_2.css">
        ...
        <div id="page-content-wrapper">
            <nav class="heading-payreto navbar navbar-expand-lg navbar-light py-3 px-4">
                <div class="d-flex align-items-center header-text">
                    ...
                    <a class="back-icon me-3" href="../employee_admin/index.php"><i class="back-icon fa-solid fa-angle-left"></i></a>
            ...
            <div class="w-100">
                <?php include "../employee_admin/content/u_records.php" ?>
            </div>
        </div>
    </div>

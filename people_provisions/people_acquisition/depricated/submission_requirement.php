...
<body>
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            <nav class="heading-payreto navbar navbar-expand-lg navbar-light py-3 px-5">
            <div class="d-flex align-items-center header-text">
                    <i class="fas fa-align-left tertiary-text fs-4 me-3" id="menu-toggle"></i>
                    <a class="back-icon me-3" href="../people_acquisition/index.php"><i class="back-icon fa-solid fa-angle-left"></i></a>
            ...
            <div class="w-100">
                <?php include "../people_acquisition/content/submission_req.php" ?>
            </div>
        </div>
    </div>

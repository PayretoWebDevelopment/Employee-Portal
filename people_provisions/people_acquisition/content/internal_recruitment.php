...
<?php
$sql = "SELECT link, id FROM p_acquisition WHERE id = 'recruitment'";
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="w-100 py-5">
                <div class="container">
                    <h1 class="card-heading my-5 text-uppercase text-center">INTERNAL RECRUITMENT APPLICATION FORM</h1>
                    <?php if (empty($link)) : ?>
                    ...
                    <?php else : ?>
                        <!-- <div class="justify-content d-flex justify-content-center">
                                <a class="card-link" href="<?php echo $link ?>" target="_blank">DIRECT LINK HERE.</a>
                            </div> -->
                        <div class="justify-content d-flex justify-content-center">

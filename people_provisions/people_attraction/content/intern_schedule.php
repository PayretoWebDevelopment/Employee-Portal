...
Client id:191794886531-p1u84fjsa0juq21m599633bfavd1rhev.apps.googleusercontent.com
Client Sheet: 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
API KEY: AIzaSyBSVe8UUi4IJpgJ3MgxwKUzLHEQIoOBWf8
...
<?php
$sql = "SELECT link, id FROM p_attraction WHERE id = 'intern_sched'";
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="w-100 py-5">
                <div class="container">
                    <h1 class="card-heading my-5 text-uppercase text-center">INTERNSHIP SCHEDULE</h1>
                    <?php if (empty($link)) : ?>
